...
var theMindInstance = new theMind(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/theMind.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  theMindInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
