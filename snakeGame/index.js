...
var snakeGameInstance = new snakeGame(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/snakeGame.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  snakeGameInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
