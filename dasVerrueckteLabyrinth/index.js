...
// } from 'dasVerrueckteLabyrinth.js';
const dasVerrueckteLabyrinth = require('./dasVerrueckteLabyrinth');
...
var dasVerrueckteLabyrinthInstance = new dasVerrueckteLabyrinth(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/dasVerrueckteLabyrinth.html', {
    root: __dirname
  });
});
...
app.post('/login', function(req, res) {
  ...
  dasVerrueckteLabyrinthInstance.onJoin({
    sessionId: clientId
  });
});
app.post('/logout', function(req, res) {
  ...
  dasVerrueckteLabyrinthInstance.onLeave({
    sessionId: clientId
  });
});
...
app.post('/message', function(req, res) {
  dasVerrueckteLabyrinthInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
