...
//   monopolyKartenspiel
// } from 'monopoly.js';
const heldenDesOlymp = require('./heldenDesOlymp');
...
var heldenDesOlympInstance = new heldenDesOlymp(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/heldenDesOlymp.html', {
    root: __dirname
  });
});
...
app.post('/logout', function(req, res) {
  ...
  heldenDesOlympInstance.onLeave({
    sessionId: clientId
  });
});
...
app.post('/message', function(req, res) {
  heldenDesOlympInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
