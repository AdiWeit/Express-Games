// import {
//   HeyDasIstMeinFisch
// } from 'HeyDasIstMeinFisch.js';
const HeyDasIstMeinFisch = require('./HeyDasIstMeinFisch');
...
var HeyDasIstMeinFischInstance = new HeyDasIstMeinFisch(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/HeyDasIstMeinFisch.html', {
    root: __dirname
  });
});
...
app.post('/login', function(req, res) {
  ...
  HeyDasIstMeinFischInstance.onJoin({
    sessionId: clientId
  });
});
app.post('/logout', function(req, res) {
  ...
  HeyDasIstMeinFischInstance.onLeave({
    sessionId: clientId
  });
});
...
app.post('/message', function(req, res) {
  HeyDasIstMeinFischInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
