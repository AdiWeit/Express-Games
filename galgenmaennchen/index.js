...
const galgenmaennchen = require('./galgenmaennchen');
...
var galgenmaennchenInstance = new galgenmaennchen(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/galgenmaennchen.html', {
    root: __dirname
  });
});
...
app.post('/login', function(req, res) {
  ...
  galgenmaennchenInstance.onJoin({
    sessionId: clientId
  });
});
app.post('/logout', function(req, res) {
  ...
  galgenmaennchenInstance.onLeave({
    sessionId: clientId
  });
});
...
app.post('/message', function(req, res) {
  galgenmaennchenInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
