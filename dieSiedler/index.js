const dieSiedler = require('./dieSiedler');

const express = require('express');
//var app = express();
const app = express.Router();

var dieSiedlerInstance = new dieSiedler(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/dieSiedler.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  dieSiedlerInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
