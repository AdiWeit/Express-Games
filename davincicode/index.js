...
//   monopolyKartenspiel
// } from 'monopoly.js';
const davincicode = require('./davincicode');
...
var davincicodeInstance = new davincicode(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/davincicode.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  davincicodeInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
