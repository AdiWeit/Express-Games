...
//   monopolyKartenspiel
// } from 'monopoly.js';
const vierGewinnt = require('./vierGewinnt');
...
var vierGewinntInstance = new vierGewinnt(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/vierGewinnt.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  vierGewinntInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
