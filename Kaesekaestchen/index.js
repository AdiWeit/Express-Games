// import {
//   KaesekaestchenKartenspiel
// } from 'Kaesekaestchen.js';
const Kaesekaestchen = require('./Kaesekaestchen');
...
var KaesekaestchenInstance = new Kaesekaestchen(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/Kaesekaestchen.html', {
    root: __dirname
  });
});
...
app.post('/logout', function(req, res) {
  ...
  KaesekaestchenInstance.onLeave({
    sessionId: clientId
  });
});
...
app.post('/message', function(req, res) {
  KaesekaestchenInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
