// import {
//   zeichenbattleKartenspiel
// } from 'zeichenbattle.js';
const zeichenbattle = require('./zeichenbattle');
...
var zeichenbattleInstance = new zeichenbattle(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/zeichenbattle.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  zeichenbattleInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
