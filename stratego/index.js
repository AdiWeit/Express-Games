...
var strategoInstance = new stratego(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/stratego.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  strategoInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
