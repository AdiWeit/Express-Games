// import {
//   asFastAsYouCan
// } from 'asFastAsYouCan.js';
const asFastAsYouCan = require('./asFastAsYouCan');
...
var asFastAsYouCanInstance = new asFastAsYouCan(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/asFastAsYouCan.html', {
    root: __dirname
  });
});
...
app.post('/logout', function(req, res) {
  ...
  asFastAsYouCanInstance.onLeave({
    sessionId: clientId
  });
});
...
app.post('/message', function(req, res) {
  asFastAsYouCanInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
