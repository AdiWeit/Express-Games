...
var QwirkleInstance = new Qwirkle(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/Qwirkle.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  QwirkleInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
