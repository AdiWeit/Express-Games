...
//   monopolyKartenspiel
// } from 'monopoly.js';
const gruselino = require('./gruselino');
...
var gruselinoInstance = new gruselino(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/gruselino.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  gruselinoInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
