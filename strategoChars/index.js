...
//   monopolyKartenspiel
// } from 'monopoly.js';
const strategoChars = require('./strategoChars');
...
var strategoCharsInstance = new strategoChars(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/strategoChars.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  strategoCharsInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
