...
//   monopolyKartenspiel
// } from 'monopoly.js';
const geduldsspiel = require('./geduldsspiel');
...
var geduldsspielInstance = new geduldsspiel(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/geduldsspiel.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  geduldsspielInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
