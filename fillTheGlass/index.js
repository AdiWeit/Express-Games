// import {
//   fillTheGlassKartenspiel
// } from 'fillTheGlass.js';
const fillTheGlass = require('./fillTheGlass');
...
var fillTheGlassInstance = new fillTheGlass(addBroadcast, addMessage);
...
app.get('/', function(req, res) {
  res.sendFile('static/fillTheGlass.html', {
    root: __dirname
  });
});
...
app.post('/message', function(req, res) {
  fillTheGlassInstance.onMessage(req.body.clientId, req.body.content)
  res.json({
    success: true
  });
});
